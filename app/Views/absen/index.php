                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            List Absen
                            <a href="<?php echo base_url('absencontroller/createmasuk'); ?>" class="btn btn-primary float-right">Masuk</a>
                            <a href="<?php echo base_url('absencontroller/createkeluar'); ?>" class="btn btn-primary float-right">Keluar</a>
                        </div>
                        <div class="card-body">
