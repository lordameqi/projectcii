...
<!-- jQuery UI 1.11.4 -->
<script
src="<?php echo base_url('themes/plugins/jquery-ui/jquery-ui.min.js')?>"></script>
...
<!-- Bootstrap 4 -->
<script
src="<?php echo base_url('themes/plugins/bootstrap/js/bootstrap.bundle.min.js')?>"></script>
<!-- ChartJS -->
...
<script
src="<?php echo base_url('themes/plugins/jqvmap/maps/jquery.vmap.usa.js')?>"></script>
<!-- jQuery Knob Chart -->
<script
src="<?php echo base_url('themes/plugins/jquery-knob/jquery.knob.min.js')?>"></script>
<!-- daterangepicker -->
<script src="<?php echo base_url('themes/plugins/moment/moment.min.js')?>"></script>
<script
src="<?php echo base_url('themes/plugins/daterangepicker/daterangepicker.js')?>"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script
src="<?php echo base_url('themes/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')?>"></script>
<!-- Summernote -->
<script
src="<?php echo base_url('themes/plugins/summernote/summernote-bs4.min.js')?>"></script>
<!-- overlayScrollbars -->
<script
src="<?php echo base_url('themes/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')?>"></script>
<!-- AdminLTE App -->
